...
if __name__ == '__main__':
    ...
    with nidaqmx.Task() as output_task, nidaqmx.Task() as input_task:
        output_task.do_channels.add_do_chan("myDAQ1/port0/line4:7", line_grouping=LineGrouping.CHAN_PER_LINE)
        input_task.di_channels.add_di_chan("myDAQ1/port0/line0:3", line_grouping=LineGrouping.CHAN_PER_LINE)
        d = 0.00
        d = d + 0.00
        while True:
